...
%\subsection{Produkcja \acrshort{mlra} w układzie \acrshort{mfc}}\label{subsec:mfc}
%W tym eksperymencie mierzono aktywność \acrshort{mlra}
%w komórkach \textit{Synechocystis sp.} PCC 6803,
%kultywowanych na BG-11 + 50 \% \acrshort{ww}2 w układzie \acrshort{mfc}\@.
%W komorze z anodą znajdowały się komórki
%\textit{R. spheroides} w \acrshort{m27} + 50 \% \acrshort{ww}2,
%o \acrshort{od}\textsubscript{600} = 0.200.
%W komorze z katodą umieszczono zawiesinę komórek
%\textit{Synechocystis sp.} PCC 6803 McCormick 7
%w BG-11 + 50 \% \acrshort{ww}2 (\acrshort{od}\textsubscript{600} = 0.200).
%Tak przygotowane komórki kultywowano w układzie \acrshort{mfc} (\ref{subsec:sprzet}).
%W~1, 4, 6 i~8 dniu eksperymentu z hodowli zbierano próbki
%celem analizy aktywności \acrshort{mlra} (\ref{subsec:\acrshort{mlra}}).