...
\subsection{Badania}\label{subsec:badania}

W niniejszej pracy skupiłem się na optymalizacji wzrostu organizmów
elektrogenicznych (\textit{Rhodobacter spheroides})
i elektrotroficznych (\textit{Synechocystis sp.} PCC 6803,
konstrukty McCormick opisane w tab. \ref{tab:1})
w środowisku o wysokim zanieczyszczeniu związkami
organicznymi oraz na optymalizacji
pomiarów napięcia elektrycznego generowanego przez obecne